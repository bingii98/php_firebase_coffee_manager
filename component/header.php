        ...
        <div class="account-tab">
            <div class="dropdown">
                ...
                <div class="dropdown-menu bg-menu-dropdown" aria-labelledby="dropdownMenu">
                    <button class="dropdown-item" type="button"><i class="fa fa-user" aria-hidden="true"></i><span>Đổi thông tin</span></button>
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" type="button" href="logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i><span>Đăng xuất</span></a>
                </div>
            </div>
        </div>
    </div>
